...
const MoviesPage: React.FC = () => {
    ...
    shawshank: [
      {
        ...
        rating: 'R',
        description: 'A supernatural drama set in a prison',
      },
      {
        showId: 's2',
        title: 'Cool Hand Luke',
        rating: 'PG-13',
        description: 'A prison drama about defiance',
      },
      {
        showId: 's3',
        title: 'Escape from Alcatraz',
        rating: 'PG',
        description: 'Based on the 1962 prison escape',
      },
      {
        showId: 's4',
        title: 'The Great Escape',
        rating: 'PG',
        description: 'WWII prisoners plan a mass escape',
      },
      {
        showId: 's5',
        title: 'Papillon',
        rating: 'R',
        description: "A prisoner's repeated attempts to escape",
      },
    ],
    inception: [
      {
      ...
      },
      {
        ...
        rating: 'R',
        description: 'A couple erases memories of each other',
      },
      {
        showId: 'i5',
        title: 'Interstellar',
    ...
    darkKnight: [
      {
        ...
        title: 'Batman Begins',
        rating: 'PG-13',
        description: "Bruce Wayne's origin story",
      },
      {
        showId: 'd2',
      ...
      },
      {
        ...
        title: 'Joker',
        rating: 'R',
        description: "The origin of Batman's nemesis",
      },
      {
        showId: 'd4',
        title: 'Man of Steel',
        rating: 'PG-13',
        description: "Superman's origin story",
      },
      {
        showId: 'd5',
        title: 'Wonder Woman',
        rating: 'PG-13',
        description: "Diana Prince's first adventure",
      },
    ],
    pulpFiction: [
      {
        ...
        rating: 'R',
        description: 'Aftermath of a jewelry store heist',
      },
      {
        showId: 'p2',
        title: 'Django Unchained',
        rating: 'R',
        description: 'A freed slave searches for his wife',
      },
      {
        showId: 'p3',
        title: 'Kill Bill',
        rating: 'R',
        description: 'A former assassin seeks revenge',
      },
      {
        showId: 'p4',
        title: 'The Hateful Eight',
        rating: 'R',
        description: 'Eight strangers seek shelter from a blizzard',
      },
      {
        showId: 'p5',
        title: 'Inglourious Basterds',
        rating: 'R',
        description: 'A plan to assassinate Nazi leaders',
      },
    ],
    godfather: [
      {
        ...
        title: 'Goodfellas',
        rating: 'R',
        description: 'The story of Henry Hill and his mobster friends',
      },
      {
        showId: 'g2',
        title: 'Casino',
        rating: 'R',
        description: 'Greed, deception, and power in Las Vegas',
      },
      {
        showId: 'g3',
        title: 'Scarface',
        rating: 'R',
        description: 'The rise and fall of Tony Montana',
      },
      {
        showId: 'g4',
        title: 'The Departed',
        rating: 'R',
        description: 'An undercover cop and an informant',
      },
      {
        showId: 'g5',
        title: 'Heat',
  ...
  useEffect(() => {
    ...
    const findBestRecommendationMatch = (recs: any[], title: string) => {
      let match = recs.find(
        (r) =>
          r.if_you_liked.toLowerCase().trim() === title.toLowerCase().trim()
      );
      if (!match) {
        match = recs.find((r) =>
          title.toLowerCase().includes(r.if_you_liked.toLowerCase())
        );
      }
      return match;
    };
    ...
    const fetchMovieDetailsForTitles = async (
      ...
      try {
        ...
        return titles
          .map((t) =>
            allMovies.find(
              (m: Movie) => m.title.toLowerCase() === t.toLowerCase()
            )
          )
          .filter(Boolean);
      } catch (err) {
      ...
      for (const movie of topRatedMovies) {
        ...
        if (bestMatch) {
          ...
          if (found.length > 0) {
            ...
            console.log(
              `Found ${found.length} recommendations for "${movie.title}"`
            );
          }
        }
      }
        ...
        >
          ...
          {topRatedMovies.length > 0 ? (
            ...
            topRatedMovies.map((movie, index) => {
              ...
              const hasRealRecs =
                recommendationsMap[movie.title] &&
                recommendationsMap[movie.title].length > 0;
