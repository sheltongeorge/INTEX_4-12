...
const MovieOverlay: React.FC<OverlayProps> = ({ movie, onClose }) => {
            ...
            <button
              ...
              onClick={() => {
                ...
                fetch(
                  ...
                  .then((res) => {
                    if (res.ok) alert(`:white_check_mark: Added "${movie.title}" to your watchlist!`);
                    else alert(':x: Failed to add to watchlist.');
                  })
